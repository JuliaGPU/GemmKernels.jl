...
function benchmark_matmul(a, b, c, d)
    CUDA.@sync begin
        ...
        CUBLAS.cublasGemmEx(CUBLAS.handle(), CUBLAS.CUBLAS_OP_T, CUBLAS.CUBLAS_OP_N, M, N, K, [Float32(1)], a, CUDA.R_16F, M, b, CUDA.R_16F, K, [Float32(1)], c, CUDA.R_32F, M, CUDA.R_32F, CUBLAS.CUBLAS_GEMM_DEFAULT)
    end
end
