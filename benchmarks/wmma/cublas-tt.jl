...
function benchmark_matmul(a, b, c, d)
    CUDA.@sync begin
        ...
        CUBLAS.cublasGemmEx(CUBLAS.handle(), CUBLAS.CUBLAS_OP_T, CUBLAS.CUBLAS_OP_T, M, N, K, [Float32(2)], a, CUDA.R_16F, M, b, CUDA.R_16F, K, [Float32(3)], c, CUDA.R_32F, M, CUDA.R_32F, CUBLAS.CUBLAS_GEMM_DEFAULT)
    end
end
